...
Install quay Mirror Registry 
    ...
    INFO[2024-01-24 20:00:42] Quay is available at https://dc1fbreg01.redprodc1.firebolt.para.in:8443 with credentials (firebolt, ######!)
...
> If Internet is available on registry node, download the ocp-base-images. 
    ...
    info: Mirroring 192 images to dc1fbreg01.redprodc1.firebolt.para.in:8443/ocp4/openshift4 ...
    dc1fbreg01.redprodc1.firebolt.para.in:8443/
    ocp4/openshift4
        blobs:
    ...
    Success
    Update image:  dc1fbreg01.redprodc1.firebolt.para.in:8443/ocp4/openshift4:4.15.0-x86_64
    Mirror prefix: dc1fbreg01.redprodc1.firebolt.para.in:8443/ocp4/openshift4
    Mirror prefix: dc1fbreg01.redprodc1.firebolt.para.in:8443/ocp4/openshift4:4.15.0-x86_64
