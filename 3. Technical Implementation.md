...
> If Internet is available on registry node, download the ocp-base-images. 
    ...
    Success
    Update image:  openshift/release:4.15.0-x86_64
    To upload local images to a registry, run:
    
        oc image mirror --from-dir=/ocpregistry/ocp-base-images/mirror 'file://openshift/release:4.15.0-x86_64*' REGISTRY/REPOSITORY
